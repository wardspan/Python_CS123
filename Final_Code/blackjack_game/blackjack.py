...
from constants import display_width, display_height, background_color, grey, black, green, red, light_slat, dark_slat, dark_red, font, textfont, game_end, blackjack
import sys
import time
...
class Play:
    ...
    def blackjack(self):
        ...
        show_dealer_card = pygame.image.load(
            "img/" + self.dealer.card_img[1] + ".png"
        ).convert()
    ...
    def deal(self):
        ...
        dealer_card = pygame.image.load(
            "img/" + self.dealer.card_img[0] + ".png"
        ).convert()
        dealer_card_2 = pygame.image.load("img/back.png").convert()

        player_card = pygame.image.load(
            "img/" + self.player.card_img[0] + ".png"
        ).convert()
        player_card_2 = pygame.image.load(
            "img/" + self.player.card_img[1] + ".png"
        ).convert()
    ...
    def hit(self):
        ...
        if self.player_card == 2:
            ...
            player_card_3 = pygame.image.load(
                "img/" + self.player.card_img[2] + ".png"
            ).convert()
        ...
        if self.player_card == 3:
            ...
            player_card_4 = pygame.image.load(
                "img/" + self.player.card_img[3] + ".png"
            ).convert()
